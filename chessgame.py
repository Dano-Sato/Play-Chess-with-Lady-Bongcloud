...
talkScript_kr = {
    ...
    "선생님의 용기가 저를 감동시킵니다.",
    "도전에도 불구하고 훌륭히 해내셨습니다.",
    "이 게임이 더욱 흥미로워졌습니다.",
    "선생님께서는 이 게임에 진정한 재능이 있으십니다.",
    "어떻게 전개될지 무척 궁금해집니다.",
    "선생님의 움직임이 저의 관심을 끌었습니다.",
    "선생님께서는 이 게임을 매혹적으로 유지하고 계십니다.",
    "선생님은 언제나 게임에 흥미로운 반전을 가져오십니다.",
    "선생님의 독특한 경기 접근 방식에 감사드립니다."
],
    'blunder':[
    ...
    'conversation':["제 이름은 봉클라우드입니다, 선생님. 하지만 샬롯이라고 부르셔도 괜찮아요.",
                    ...
                    "우리 가문에서는 봉클라우드 공격을 신성한 체스 동작으로 여깁니다.",
                   ...
                   "봉클라우드 어택은 게임에 흥미와 예측 불가능성을 더해줄 수 있답니다.",
                   "저와 함께 플레이해주셔서 감사합니다, 선생님. 좋은 경기가 되길 바랍니다.",
                   "선생님과 대결하게 되어 정말 기쁩니다. 최고의 선수가 승리하길 바랍니다!",
                   "즐거운 경기가 되시길, 선생님. 최선을 다합시다.",
                   ...
                   "당신은 잠재력이 있으십니다, 선생님. 게임을 당신의 것으로 만드세요!",
                   "당신의 능력을 믿으세요, 선생님.",
                   "자신을 믿으세요, 선생님.",
                   "선생님, 체스판은 당신의 캔버스입니다. 당신의 탁월함으로 그림을 그려보세요!",
                   "턱을 높이 드세요, 선생님.",
                   "희망을 잃지 마세요, 선생님.",
    ...
    'swap':[
    "선생님, 제가 당신 편을 들고, 당신은 제 편을 들어주시면 어떨까요?",
    "선생님, 제가 선생님 편을 선택하여 새로운 체스 경험을 제공해드리겠습니다.",
    "이것은 우리에게 새로운 방식으로 적응하고, 다르게 생각하도록 이끌어줍니다.",
    "게임에 흥미로운 반전을 더해드릴 것입니다.",
    "흥미를 더해주지 않나요, 선생님?",
    "조금 더 흥미롭게 느껴지지 않으신가요, 선생님?"
],
...
talkScript_jp = {
    ...
    "私の家では、ボンクラウド・アタックは神聖なチェスの一手とされています。",
    "楽しい一日をお過ごしでしょうか？",
    "良い一日をお過ごしのことと思います。",
    "お役に立てて光栄です。",
    ...
    "対戦してくださってありがとうございます、サー。良い試合にしましょう。",
    ...
    "あなたには無限の可能性があります。このゲームを有利に進めましょう！",
    "自分の力を信じてください。",
    "どうか自分を信じてください。",
    ...
    "あなたと一緒にいると、私は完全であると感じます、サー。",
    "あなたは私にとって最も大切な場所です。",
    "あなたは灰色の世界における私の太陽です、先生。",
    "あなたの近くにいることが、私にとって純粋な幸せです。",
    "あなたと共に、私は自分の居場所を見つけました。"
],
    'costume':[
